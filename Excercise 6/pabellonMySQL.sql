...
INDEX Cirugías_FKIndex4(Pabellones_numero_pabellon),
  FOREIGN KEY(Módulo_idMódulo)
    REFERENCES Módulo(idMódulo)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
...
CREATE TABLE Agendar_cirugía_has_En_pabellon (
  ...
  En_pabellon_idEn_pabellon INTEGER UNSIGNED  NOT NULL    ,
PRIMARY KEY(Agendar_cirugía_idAgenda, En_pabellon_idEn_pabellon)  ,
INDEX Agendar_cirugía_has_En_pabellon_FKIndex1(Agendar_cirugía_idAgenda)  ,
INDEX Agendar_cirugía_has_En_pabellon_FKIndex2(En_pabellon_idEn_pabellon),
...
INDEX Agendar_cirugía_has_Realizadas_FKIndex1(Agendar_cirugía_idAgenda)  ,
...
INDEX Instrumentos_FKIndex1(Pabellones_numero_pabellon)  ,
