...
CREATE INDEX Cirugías_FKIndex4 ON Cirugías (Pabellones_numero_pabellon);
...
CREATE TABLE Agendar_cirugía_has_En_pabellon (
  Agendar_cirugía_idAgenda INTEGER   NOT NULL ,
  En_pabellon_idEn_pabellon INTEGER   NOT NULL   ,
PRIMARY KEY(Agendar_cirugía_idAgenda, En_pabellon_idEn_pabellon)    ,
  FOREIGN KEY(Agendar_cirugía_idAgenda)
    REFERENCES Agendar_cirugía(idAgenda)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
  FOREIGN KEY(En_pabellon_idEn_pabellon)
    REFERENCES En_pabellon(idEn_pabellon)
      ON DELETE RESTRICT
      ON UPDATE CASCADE);


CREATE INDEX Agendar_cirugía_has_En_pabellon_FKIndex1 ON Agendar_cirugía_has_En_pabellon (Agendar_cirugía_idAgenda);
CREATE INDEX Agendar_cirugía_has_En_pabellon_FKIndex2 ON Agendar_cirugía_has_En_pabellon (En_pabellon_idEn_pabellon);
...
CREATE TABLE Agendar_cirugía_has_Realizadas (
  Agendar_cirugía_idAgenda INTEGER   NOT NULL ,
  Realizadas_idRealizadas INTEGER   NOT NULL   ,
PRIMARY KEY(Agendar_cirugía_idAgenda, Realizadas_idRealizadas)    ,
  FOREIGN KEY(Agendar_cirugía_idAgenda)
    REFERENCES Agendar_cirugía(idAgenda)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
...
CREATE INDEX Agendar_cirugía_has_Realizadas_FKIndex1 ON Agendar_cirugía_has_Realizadas (Agendar_cirugía_idAgenda);
...
CREATE INDEX Instrumentos_FKIndex1 ON Instrumentos (Pabellones_numero_pabellon);
